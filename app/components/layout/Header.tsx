  ...
  return (
    ...
    <header className="border-b border-[#001A2D] sticky top-0 bg-[#001A2D] z-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        {/* Desktop Navigation - Đổi màu chữ thành trắng */}
        <nav className="hidden md:flex items-center space-x-8">
          <Link href="/products/main" className="text-white font-semibold hover:text-lime-500">Trang chủ</Link>
        ...
        {/* Icons and Mobile Menu Button - Đổi màu icon/chữ thành trắng */}
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            <Link href="/sign-in" className="text-white hover:opacity-80">
              Đăng nhập
            </Link>
          </div>
      ...
      {/* Mobile Menu - Đổi màu nền và chữ */}
      {isMenuOpen && (
        <nav className="md:hidden bg-[#001A2D] border-t border-[#001A2D]">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/sign-in" className="block px-3 py-2 rounded-md text-base text-white hover:bg-lime-500">Đăng nhập</Link>
          </div>
        </nav>
      )}
    </header>
